<template>
    ...
    <RadioButton inputId="videoid" v-model="model" :value="datavalue" />
    {{ datavalue }}
    <label for="videoid" class="mx-2 mb-0">{{ label }}</label>
    <!-- <div class="d-flex align-items-center">
        <RadioButton :disabled="disabled" v-model="model" :value="datavalue" :inputId="id" @blur="handleBlur"
            :class="{ 'p-invalid': errorMessages.length }" @input="$emit('update:modelValue', model)"
            @change="$emit('change')" ref="inputField" :placeholder="placeholder" @keyup="$emit('keyup')"

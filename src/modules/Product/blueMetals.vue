    ...
    <div>
        ...
        <b-container>
            ...
            <div class="mb-5">
                ...
                <p class="txt-d  my-5
        ">
                    Its widespread use is attributed to its durability, strength, and suitability for various
                    construction and infrastructure projects. The choice of blue metal size and application depends on
                    the specific requirements of the project. It serves as a foundational material for road bases,
                    sub-bases, and as an aggregate in asphalt mixes, contributing to the stability and load-bearing
                    capacity of roads.  

                </p>
                <p class="txt-d my-5
        ">
                    Sizes like 6 mm, 12 mm, 20 mm, 40mm, WMM, and GSB is primarily used in making concrete. Because it
                    is a clean, crushed rock, it is also ideal for drainage, particularly around agricultural pipes.
